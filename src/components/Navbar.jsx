    ...
    <div className='Ultimate'>
        <div className='sub'>
              ...
              <div className='sub2'>
                ...
                <img src="https://fontawesome.com/icons/magnifying-glass?f=classic&s=solid" alt="" className='search' />
                <img src="https://w7.pngwing.com/pngs/769/262/png-transparent-gear-gears-miscellaneous-color-cartoon-thumbnail.png" alt="" className='gear' />
